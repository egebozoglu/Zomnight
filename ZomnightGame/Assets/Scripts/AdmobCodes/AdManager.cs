...
public class AdManager : MonoBehaviour
{
...
#elif UNITY_ANDROID
        deviceIds.Add("988a1b37454139384530");
#endif
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-1282117366435182/3618640255";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-1282117366435182/5914465251";
#else
        string adUnitId = "unexpected_platform";
#endif
    ...
    public void ShowRewardedAd()
    {
        ...
        else
        {
            ...
            UIManager.instance.InstantiateError("Rewarded ad is not ready yet.");
        }
    }
